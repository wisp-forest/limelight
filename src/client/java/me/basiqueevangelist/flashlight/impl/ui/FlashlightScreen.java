...
import me.basiqueevangelist.flashlight.impl.ResultGatherer;
import me.basiqueevangelist.flashlight.impl.pond.TextFieldWidgetAccess;
import me.basiqueevangelist.flashlight.impl.util.ReactiveUtils;
import net.minecraft.util.Identifier;
import org.jetbrains.annotations.NotNull;

import java.util.concurrent.TimeUnit;

public class FlashlightScreen extends BaseOwoScreen<FlowLayout> {
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        ((TextFieldWidgetAccess) searchBox).flashlight$setDrawShadow(false);
